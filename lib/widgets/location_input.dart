...
class _LocationInputState extends ConsumerState<LocationInput> {
  ...
  String get locationImage {
    ...
    if (formReader.pickedLocation == null) {
      return '';
    }
    final lat = formReader.pickedLocation!.latitude;
    final lng = formReader.pickedLocation!.longitude;
  ...
  Widget build(BuildContext context) {
    ...
    if (formWatcher.pickedLocation != null) {
